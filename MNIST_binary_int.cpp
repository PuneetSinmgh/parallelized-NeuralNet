...
int main(){
	...
	FILE *fp;
	char filename1[] ="/home/puneetsingh/dic-projects/parallelized-NeuralNet/mnist_train.csv";// training input file link
	char filename2[] ="/home/puneetsingh/dic-projects/parallelized-NeuralNet/mnist_test.csv";// testing input file link
	FILE *write_out ;// file pointer for output file
	write_out = fopen("/home/puneetsingh/dic-projects/parallelized-NeuralNet/training-reportdaa.txt","w");// file link to write the output of model and testing results
